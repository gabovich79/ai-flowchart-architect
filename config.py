...
UI_TEXT = {
    "en": {
        ...
        "error_api": "API error: {}",
        "error_no_key": "API key not found. Configure OPENAI_API_KEY in Streamlit Secrets or .env file.",
    ...
    "he": {
        ...
        "error_api": "שגיאת API: {}",
        "error_no_key": "מפתח API לא נמצא. הגדר OPENAI_API_KEY ב-Streamlit Secrets או בקובץ .env.",
